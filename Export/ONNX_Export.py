...
encoder.load_state_dict(torch.load("./ESPERNetEncoder-12000.pth", map_location="cpu"))
decoder.load_state_dict(torch.load("./ESPERNetDecoder-12000.pth", map_location="cpu"))
classifier.load_state_dict(torch.load("./ESPERNetClassifier-12000.pth", map_location="cpu"))

encoder_path = Path("./ESPERNetEncoder-12000.onnx")
decoder_path = Path("./ESPERNetDecoder-12000.onnx")
classifier_path = Path("./ESPERNetClassifier-12000.onnx")
